  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-[3px] 
                        bg-gradient-to-b from-purple-600 to-purple-900 h-full rounded-full"></div>
        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            <div className="z-20 flex justify-center mb-10 md:mb-0 md:absolute md:left-1/2 md:transform md:-translate-x-1/2">
            ...
            <div
              className={`hidden md:block absolute top-1/2 w-[calc(50%-2rem)] h-[2px] bg-gradient-to-r 
            ...
            <div
              className={`
                ...
                w-full md:w-[45%] 
                mt-4 md:mt-0 
                p-6 rounded-2xl border border-purple-600/40
